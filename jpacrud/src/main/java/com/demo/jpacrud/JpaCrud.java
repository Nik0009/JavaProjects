...
public class JpaCrud 
{
	...
	public static void main( String[] args )
    {
    	...
    	//	JpaCrud.findByNamedQuery();     Line 36,37,42,44 code not working
	...
	// create find by fuzzy named query
	...
	// create criteria verified users  query
	...
	// create criteria login name and password query
	...
	// create criteria find by common password  query
	...
	// create criteria fuzzy email query
	...
	// create criteria between dates  query
